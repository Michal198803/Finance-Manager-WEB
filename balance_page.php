...
switch ($period) {
    ...
    case 2:
        ...
        break;
    case 3:
        $query = "SELECT incomes.amount, incomes_category_assigned_to_users.name, incomes.date_of_income, incomes.income_comment FROM incomes LEFT OUTER JOIN incomes_category_assigned_to_users ON incomes.income_category_assigned_to_user_id = incomes_category_assigned_to_users.id WHERE incomes.user_id = '$user_id'AND YEAR(incomes.date_of_income) = YEAR(current_date) order by incomes.amount desc ";
        $income_result = $connect->query($query);
        break;
    ...
    case 4:
        if (isset($_POST['date_begin'])) {
            $date_begin = $_POST['date_begin'];
            $date_end = $_POST['date_end'];
            $query = "SELECT incomes.amount, incomes_category_assigned_to_users.name, incomes.date_of_income, incomes.income_comment FROM incomes LEFT OUTER JOIN incomes_category_assigned_to_users ON incomes.income_category_assigned_to_user_id = incomes_category_assigned_to_users.id WHERE incomes.user_id = '$user_id' AND   incomes.date_of_income >='$date_begin' AND incomes.date_of_income <='$date_end' order by incomes.amount desc ";
            $income_result = $connect->query($query);
            unset($date_begin);
            unset($date_end);
        }
...
switch ($period) {
    ...
    case 1:
        $query = "SELECT expenses.amount, payment_methods_assigned_to_users.name, expenses.date_of_expense, expenses_category_assigned_to_users.name name2, expenses.expense_comment FROM expenses LEFT OUTER JOIN expenses_category_assigned_to_users ON expense_category_assigned_to_user_id = expenses_category_assigned_to_users.id LEFT OUTER JOIN payment_methods_assigned_to_users ON expenses.payment_method_assigned_to_user_id = payment_methods_assigned_to_users.id WHERE expenses.user_id = '$user_id' AND EXTRACT(YEAR_MONTH FROM expenses.date_of_expense) = EXTRACT(YEAR_MONTH FROM current_date) order by expenses.amount desc ";
        ...
        break;
    case 2:
        $query = "SELECT expenses.amount, payment_methods_assigned_to_users.name, expenses.date_of_expense, expenses_category_assigned_to_users.name name2, expenses.expense_comment FROM expenses LEFT OUTER JOIN expenses_category_assigned_to_users ON expenses.expense_category_assigned_to_user_id = expenses_category_assigned_to_users.id LEFT OUTER JOIN payment_methods_assigned_to_users ON expenses.payment_method_assigned_to_user_id = payment_methods_assigned_to_users.id WHERE expenses.user_id = '$user_id'  AND EXTRACT(YEAR_MONTH FROM expenses.date_of_expense) = EXTRACT(YEAR_MONTH FROM current_date) -1 order by expenses.amount desc";
        $expenses_category_number = ("SELECT expenses_category_assigned_to_users.name name ,SUM(expenses.amount) count FROM expenses LEFT OUTER JOIN expenses_category_assigned_to_users ON expenses.expense_category_assigned_to_user_id = expenses_category_assigned_to_users.id where expenses.user_id = '$user_id' AND EXTRACT(YEAR_MONTH FROM expenses.date_of_expense) = EXTRACT(YEAR_MONTH FROM current_date) - 1 GROUP BY expenses_category_assigned_to_users.name");
        $result_expenses_category_number = mysqli_query($connect, $expenses_category_number);
        $expense_result = $connect->query($query);
        break;
    case 3:
        $query = "SELECT expenses.amount, payment_methods_assigned_to_users.name, expenses.date_of_expense, expenses_category_assigned_to_users.name name2, expenses.expense_comment FROM expenses LEFT OUTER JOIN expenses_category_assigned_to_users ON expenses.expense_category_assigned_to_user_id = expenses_category_assigned_to_users.id LEFT OUTER JOIN payment_methods_assigned_to_users ON expenses.payment_method_assigned_to_user_id = payment_methods_assigned_to_users.id WHERE expenses.user_id = '$user_id' AND YEAR(expenses.date_of_expense) = YEAR(current_date) order by expenses.amount desc";
    ...
    case 4:
        if (isset($_POST['date_begin'])) {
            $date_begin = $_POST['date_begin'];
            $date_end = $_POST['date_end'];
            $query = "SELECT expenses.amount, payment_methods_assigned_to_users.name, expenses.date_of_expense, expenses_category_assigned_to_users.name name2, expenses.expense_comment FROM expenses LEFT OUTER JOIN expenses_category_assigned_to_users ON expenses.expense_category_assigned_to_user_id = expenses_category_assigned_to_users.id LEFT OUTER JOIN payment_methods_assigned_to_users ON expenses.payment_method_assigned_to_user_id = payment_methods_assigned_to_users.id WHERE expenses.user_id = '$user_id' AND   expenses.date_of_expense >='$date_begin' AND expenses.date_of_expense <='$date_end' order by expenses.amount desc";
