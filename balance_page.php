...
if(isset($_POST['period'])){
    ...
    switch ($period) {
        ...
        case 2:
            ...
            break;
        case 3:
            $query = "SELECT incomes.amount, incomes_category_assigned_to_users.name, incomes.date_of_income, incomes.income_comment FROM finance_manager.incomes LEFT OUTER JOIN finance_manager.incomes_category_assigned_to_users ON incomes.income_category_assigned_to_user_id = incomes_category_assigned_to_users.id WHERE incomes.user_id = '$user_id'AND EXTRACT(YEAR FROM incomes.date_of_income) = EXTRACT(YEAR FROM current_date)";
            break;
    ...
    switch ($period) {
        ...
        case 2:
            ...
            break;
        case 3:
            $query = "SELECT expenses.amount, payment_methods_assigned_to_users.name, expenses.date_of_expense, expenses_category_assigned_to_users.name name2, expenses.expense_comment FROM finance_manager.expenses LEFT OUTER JOIN finance_manager.expenses_category_assigned_to_users ON expenses.expense_category_assigned_to_user_id = expenses_category_assigned_to_users.id LEFT OUTER JOIN finance_manager.payment_methods_assigned_to_users ON expenses.payment_method_assigned_to_user_id = payment_methods_assigned_to_users.id WHERE expenses.user_id = '$user_id'  AND EXTRACT(YEAR FROM expenses.date_of_expense) = EXTRACT(YEAR FROM current_date)";
            break;
